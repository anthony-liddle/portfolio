export const metadata = {
  ...
  description:
    'Write a secret. Watch it dematerialize over 60 seconds. Nothing is saved, by design, not policy. A small web experience built in vanilla TypeScript.',
  openGraph: {
...
Privacy here is a constraint, not a feature. It shapes every decision.
