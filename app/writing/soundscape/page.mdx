...
There's also something to be said for trusting your own work when you've been pulling on a thread for over a decade. By the time I started Soundscape, I'd written Web Audio code many different times. I knew what the API could do.

I'm not against libraries. I built this one myself because I'd been building close to it long enough that the work was more interesting than the dependency.
...
The engine has ended up providing sound for several other projects of mine. A friend started writing their own songs in it and sending me the exported JSON so I can load them into the composer and listen.
