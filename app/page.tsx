    ...
    <div className="page-container">
      ...
      <section aria-labelledby="hero-heading">
        ...
        <p className="home-hero__paragraph">
          ...
          performance platform. I have fifteen years of experience building
          data-intensive web and mobile products, most recently at Microsoft and
          Mozilla, where I co-architected two generations of Pocket&rsquo;s web
          client over six years.
        </p>
        <p className="home-hero__paragraph">
          On my own time I build small tools and ephemeral experiments, often
          composed from systems I&rsquo;ve written for previous projects. The
          audio in one is composed in another. The animations in a third were
          generated by a fourth. The work loops back on itself.
        </p>
      </section>
